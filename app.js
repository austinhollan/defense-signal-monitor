...
// === POSITION CHANGES — Mar 2, 2026 Update (Hourly refresh) ===
const positionChanges = [
    { ticker: "LHX", company: "L3Harris Technologies", price: 349.15, dayChange: 2.64,
        oldScore: 4,
        newScore: 5,
        action: "UPGRADE",
        priority: "BUY",
    ...
    { ticker: "PLTR", company: "Palantir Technologies", price: 133.32, dayChange: 0.92,
        oldScore: 4,
        newScore: 5,
        action: "UPGRADE",
        priority: "BUY",
    ...
    { ticker: "BAESY", company: "BAE Systems ADR", price: 114.01, dayChange: 0.91,
        oldScore: 3,
        newScore: 4,
        action: "UPGRADE",
        priority: "BUY",
    ...
    { ticker: "BAH", company: "Booz Allen Hamilton", price: 79.63, dayChange: -1.18,
        oldScore: -5,
        newScore: -3,
        action: "UPGRADE",
        priority: null,
    ...
    { ticker: "SAIC", company: "Science Applications", price: 91.16, dayChange: 0.61,
        oldScore: -3,
        newScore: -2,
        action: "UPGRADE",
        priority: null,
    ...
    { ticker: "NOC", company: "Northrop Grumman", price: 704.93, dayChange: 1.90,
        oldScore: 4,
        newScore: 5,
        action: "UPGRADE",
        priority: "BUY",
    ...
    { ticker: "HII", company: "Huntington Ingalls", price: 434.48, dayChange: 0.34,
        oldScore: 4,
        newScore: 5,
        action: "UPGRADE",
        priority: "BUY",
    ...
    { ticker: "BWXT", company: "BWX Technologies", price: 202.57, dayChange: -0.61,
        oldScore: 4,
        newScore: 5,
        action: "UPGRADE",
        priority: "BUY",
        ...
        signal: "Nuclear emphasis in $153B spend — sub reactors, B-21 nuclear systems, Golden Dome. Record $7.4B backlog. Zero DOGE risk.",
        catalysts: ["Nuclear spend surge", "$7.4B backlog", "Structural tailwind"]
    },
    { ticker: "RKLB", company: "Rocket Lab USA", price: 70.39, dayChange: -4.89,
        oldScore: 4,
        newScore: 4,
        action: "HOLD",
        priority: null,
        priorityUrgency: null,
        priorityRationale: null,
        signal: "Golden Dome $24B (classified) benefits space-based tracking. $816M SDA contract intact.",
        catalysts: ["Golden Dome $24B", "SDA HALO demo"]
    },
    { ticker: "KTOS", company: "Kratos Defense", price: 89.04, dayChange: -6.47,
        oldScore: 4,
        newScore: 3,
        action: "DOWNGRADE",
        priority: "REDUCE",
        priorityUrgency: "medium",
        priorityRationale: "Second consecutive selloff day. CCA timeline is multi-year — near-term catalysts exhausted after AFA Symposium. Trim and redeploy capital to NOC/HII/BWXT where reconciliation dollars flow immediately.",
        signal: "-6.47% pre-market move. Market skepticism on execution timeline.",
        catalysts: ["Pre-market selloff", "Execution concern", "CCA timeline risk"]
    },
    { ticker: "CRWD", company: "CrowdStrike", price: 377.41, dayChange: -2.39,
        oldScore: 1,
        newScore: 0,
        action: "DOWNGRADE",
        priority: "EXIT",
        priorityUrgency: "high",
        priorityRationale: "Post-earnings weakness. Cyber sector rotation underway — capital better deployed in hardware primes benefiting from $153B reconciliation.",
        signal: "Earnings miss — stock -9.85% Feb 23. Moving to excluded on negative momentum.",
        catalysts: ["Earnings miss", "Execution failure"]
    }
];
...
// 6 months: Aug 29, Sep 30, Oct 31, Nov 30, Dec 31, Jan 31, Feb 27
...
function renderTheaterIntel() {
    ...
    grid.innerHTML = theaterIntelData.map(theater => {
        ...
        const sourcesHTML = theater.sources.map(s => `<a href="${s.url}" target="_blank" rel="noopener" class="source-link">${s.name}</a>`).join(' • ');
